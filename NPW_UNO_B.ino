 ...
 *  Würfelumriss und kleines Drehkreuz in Mitte mit Farbanimation (fi3) 
 *  dann:
 ...
 * 
 * Würfel
 * wu1 = Würfel zufallswerte rechtwinklig
 * wu2 = Würfel zufallswerte 45grad
...
void setup() {
  ...
  anico = 0;          //animcounter  
  //Serial.println();
  Serial.println(F("DEMO Mode, aus mit d"));                 
}
...
void anista() {         //von hier werden die einzelnen Animationen aufgerufen
  switch (anima)  {
    ...
    case 2:          //
     ...
     break;
    case 3:          //mini Würfel mit Zufallswerten
     aniwu2();
     break; 
    case 4:
     test();        // Testprgm.
...
void demo()  {     // Demo mode    - abhängig vom sekunden counter werden Animationen per Zufall gestartet      
  ...
  do {
    demco = random8(0,14);           // random demo 
    for( a1 = 0; a1 < 6; a1++) {
  ...
  switch (demco) {
     ...
     case 1: 
        ...
        wert1 = 'f';  wert2 = 'i';  wert3 = '2';   //schaltet Würfel Umriss ein
     break;
      //
     case 2:
        sekco = 10;          // Sekundencounter geändert
        wert1 = 's';  wert2 = 'p';  wert3 = '1'; //Sprudel langsame Farbänderun
      break;
      //    
     case 3:
     ...
     case 8:
        sekco = 12;          // Sekundencounter
        wert1 = 'w';  wert2 = 'u';  wert3 = '1'; //Zufallswürfel rechtwinklig
      break;
      //
     case 9:
        sekco = 12;          // Sekundencounter
        wert1 = 'w';  wert2 = 'u';  wert3 = '2'; //Zufallswürfel 45 grad
      break;
      //
     ...
     case 11:
        sekco = 12;          // Sekundencounter
        wert1 = 'w';  wert2 = 'u';  wert3 = '3'; //Zufallswürfel rechtwinklig & 45 grad
      break;   
     //     
     case 12: 
        sekco = 12;          // Sekundencounter        
     ...
     case 13: 
        sekco = 12;          // Sekundencounter        
        wert1 = 'f';  wert2 = 'i';  wert3 = '3'; //Würfelumriss und kleines Drehkreuz 
...
}// ende void aniwu2() {           // Animationen mini Würfel2 per Zufallszahlen 
  ...
  if (wert1 == 'p') {     // Poti / Tastatursteuerung umschaltung
   ...
   prifa();    
    ...
    if (wert2 == 'u')  {     //ascii u für Würfel animationen
      ...
      farb1();  //alle Leds auf default Farbwerde einschalten HUE1,SAT1,VALU1)
      //
      if (wert3 == '1') {    //animation Würfel Zufallswerte rechtwinklige Bewegung 
      ...
      else if (wert3 == '2') {    //animation Würfel Zufallswerte 45 grad Bewegung
      anima = 3;           // animations auswahl, welche anim gezeigt wird, 0 = keine      
        rws = 7;              // Startwert für Random generator
        rwe = 19;              // Endwert für Random generator                   
      }      
      else if (wert3 == '3') {    //animation Würfel Zufallswerte rechtwinklige & 45 grad Bewegung
      anima = 3;           // animations auswahl, welche anim gezeigt wird, 0 = keine      
        rws = 1;              // Startwert für Random generator
        rwe = 19;              // Endwert für Random generator                  
      }
