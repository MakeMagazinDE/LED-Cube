// Filename als String
String filn = "NPW_esp8266_V1.ino"; 
/*  
 *  ###########################################
 ...
 *  
 *  LED_OUT 2   (GPIO2)           // Datenausgang zum Neopixelwürfel
 *  GPIO 13           //extern angeschlossene LED blinkt alle 2 sek. wenn PRGM. läuft
 *  
 ...
 * wu3 = Würfel zufallswerte 45grad & rechtwinklig
*/
...
#define CLED 13           //ESP 8266 - extern angeschlossene Control Led blinkt alle 2 sek. wenn PRGM. läuft
                          // Arduino ATMega 2650 und UNO ist das die interne LED
...
void setup() {
  ...
  WiFi.forceSleepBegin();             //muß unbedingt drin sein
  delay (10);
          ...
          if (ttyb == 1)  {
            ...
            switch (ttyin) {
             ...
             case '3':          //               
              ...
              Serial.print("mehr Funkel Leds "); Serial.println(funkl);              
              break;
             //
             case '4':          //              
              if (funkl > 2) {
              ...
              Serial.print("weniger Funkel Leds  "); Serial.println(funkl);               
              break;
              //
             case '5':          //              
              anig = 60;
             ...
             case 'F':          // setzt default Farbwerte
              ...
              break;
              //
             case 'G':                //  Animationsgeschindigkeit mit Poti oder Tastatur einstellen
                                      //- kleinere Werte = höhere Geschwindigkeit
             Serial.println("Ani.Tempo adj.");    // Geschindigkeit mit Poti / Tastatur
              pots = 20;          
              break;
             //
...
void setfa()  {       //set default Farbwerte
  ...
  valu1 = 28;       // variable für Value1        // je nach Variante des WS2812 von           
...
void prifa()  {             // Serial print farbe
  Serial.print("HUE1 "); Serial.print(hue1); Serial.print(" HUE2 "); Serial.print(hue2); 
  Serial.print(" HUE3 "); Serial.println(hue3); 
  Serial.print("SAT1. "); Serial.print(sat1); Serial.print(" SAT2. "); Serial.print(sat2); 
  Serial.print(" SAT3. "); Serial.println(sat3); 
  Serial.print("VAL1. "); Serial.print(valu1); Serial.print(" VAL2. "); Serial.print(valu2); 
  Serial.print(" VAL3. "); Serial.println(valu3);
}
...
void demo()  {     // Demo mode    - abhängig vom sekunden counter werden Animationen per Zufall gestartet      
  ...
  do {
    demco = random8(0,18);           // random demo 
    for( a1 = 0; a1 < 6; a1++) {
  ...
  switch (demco) {
     ...
     //
     case 2:         
        wert1 = 'w';  wert2 = 'u';  wert3 = '2';   //wu2 Würfel 2   
     break;
     //
     case 3: 
