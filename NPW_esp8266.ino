 ...
 *  Würfelumriss und kleines Drehkreuz in Mitte mit Farbanimation (fi4)  
 *  dann:
 ...
 * fi2 = innerer Würfel ein
 * fi3 = Würfel Umriss ein mit Farbanimation 
 * fi4 = Würfelumriss und kleines Drehkreuz in Mitte mit Farbanimation
 * 
 * --- Animationen ---
 * Funkeln
 ...
 * 
 * Würfel
 * wu1 = Würfel umlaufend vertikal
 * wu2 = Würfel umlaufend vertikal & horizontal  
 * wu3 = Würfel schräg vertikal & oben entlang
 * wu4 = Würfel zufallswerte rechtwinklig
 * wu5 = Würfel zufallswerte 45grad
 * wu6 = Würfel zufallswerte 45grad & rechtwinklig
 * 
 * 
...
#define LED_OUT 2              // Datenausgang zum Neopixelwürfel                                // 
...
#define CLED 13     //ESP 8266 - extern angeschlossene Control Led blinkt alle 2 sek. wenn PRGM. läuft
                    // beim Arduino ATMega 2650 und UNO ist das die interne LED
...
byte umr[] = {0,1,2,3,4,9,14,19,24,23,22,21,20,15,10,5,45,25,70,50,95,75,49,29,54,74,99,79,
                ...
                43,38,33,32,31,36,41,42,58,68,56,66,91,92,93,88,83,82,81,86,  //innerer Würfel 20 lepra = 20
                                                                            // arstp = 44
                57,62,67,37,87,63,61,      // kleines Kreuz in Mitte arstp = 64, lepra = 7
                61,62,63,42,32,92,82};      // kleines Kreuz in Mitte diagonal arstp = 71, lepra = 7
...
void setup() {
  ...
  WiFi.mode( WIFI_OFF );              // WLAN aus, die WLAN Funktionen des ESP8266 werden nicht genutzt
  WiFi.forceSleepBegin();             //muß drin sein
  delay (10);
  ...
  anico = 0;          //animcounter  
  Serial.println();
  Serial.println(F("Im DEMO Mode - ausschalten mit  d "));
          ...
          if (ttyb == 1)  {
            ...
            switch (ttyin) {
             ...
             case 'n':        //toggle langsamer Farbwechsel an/aus 
              ...
              break;
             //
             case 'r':        //Richtung vorwärts/ rückwärts - Säulen, Würfel wu1 bis wu3  
              Serial.println(F("Richtung vorwärts/rückwärts"));                            
             ...
             case 'M':          // Tastaturpoti -15
              ...
              for (byte i = 0; i < 4; i++)  {
               ...
               Serial.print(F("Serial in: "));Serial.write(wert1);
...
void demo()  {     // Demo mode    - abhängig vom sekunden counter werden Animationen per Zufall gestartet      
  ...
  do {
    demco = random8(0,19);           // random demo 
    for( a1 = 0; a1 < 6; a1++) {
  ...
  switch (demco) {
     ...
     case 1: 
        ...
        wert1 = 'f';  wert2 = 'i';  wert3 = '3';   //Würfel Umriss ein mit Farbanimation
     break;
     //
     case 2:         
        wert1 = 'w';  wert2 = 'u';  wert3 = '2';   //animation Würfel 2 schräg hoch, runter, 
                                                    //senkrecht runter  
     break;
     //
     case 3: 
        wert1 = 's';  wert2 = 'l';  wert3 = '2';   //Säule 1 Doppel Schrägsäule
      break;
     // 
     case 4:   
        //drehrichtung ändern 
        ...
        wert1 = 's';  wert2 = 'l';  wert3 = '3';   //Säule 2 Doppel Schrägsäule ausgefüllt
      break;
     //
     case 5: 
      sekco = 4;          // Sekundencounter geändert
        wert1 = 's';  wert2 = 'l';  wert3 = '5';   //Säule 4 umlaufend
      break;
     //
     case 6: 
     ...
     //
     case 7: 
        wert1 = 's';  wert2 = 'c';  wert3 = '3';   //Schlange rechtwinklig & 45 grad
      break;
     //  
     case 8: 
        wert1 = 's';  wert2 = 'l';  wert3 = '9';   //2 Wendel
      break;
     // 
     case 9:
     ...
     case 10:
      ...
      //
     case 11: 
        wert1 = 's';  wert2 = 'p';  wert3 = '1'; //Sprudel langsam wechelnde Farben 
      break;
      //       
     case 12:
        anima = 0;
     ...
     case 14:
      ...
      //
     case 15:
        wert1 = 'w';  wert2 = 'u';  wert3 = '4'; //Zufallswürfel rechtwinklig
      break;
      //
     case 16:
        wert1 = 'w';  wert2 = 'u';  wert3 = '5'; //Zufallswürfel 45 grad
      break;
      //
     case 17:               // standart Farben oder bunte Leds
     ...
     //
     case 18:
        wert1 = 'w';  wert2 = 'u';  wert3 = '6'; //Zufallswürfel rechtwinklige & 45 grad Bewegung
      break;
      //
     default:
     demco = 0;
...
/////////////////////////////////////////////////////////////////////////////////
void aniwu1() {           // Animationen Würfel 1 
                //jede zahl steht für einen Würfel = 8 Leds       //vertikal vor & zurück
byte aniw[] = {0,16,32,48,49,50,51,35,19,3,2,1,0,20,36,52,53,54,55,39,         // 20
                23,7,6,5,4,24,40,56,57,58,59,43,27,11,10,9,8,28,44,60,         // 20
                61,62,63,47,31,15,14,13,12,24,40,56,57,58,59,43,27,11,10,9,    // 20
                8,20,36,52,53,54,55,39,23,7,6,5,4,                             // 13 = 73 einträge 
                                                                               //mit 0 beginnend anza = 72 
               0,1,2,3,7,11,15,14,13,12,8,4,0,17,18,19,23,27,31,30,            // 20
               29,28,24,20,16,33,34,35,39,43,47,46,45,44,40,36,32,49,50,51,    // 20
               55,59,63,62,61,60,56,52,48,33,34,35,39,43,47,46,45,44,40,36,    // 20
               32,17,18,19,23,27,31,30,29,28,24,20,0,1,2,3,7,11,15,14,         // 20
               13,12,8,4,                                                      // 4 = 84 einträge, 83 mit 0 beginnend

               //0,20,40,60,45,30,15,31,47,63,43,23,3,2,22,42,62,61,41,21,1};     //21 Einträge, schräg hoch und runter
                                                                               //arstp=157, anza=20           
               0,20,40,60,56,52,48,49,50,51,55,59,63,62,61,60,
               45,30,15,31,47,63,43,23,3,2,22,42,62,61,41,21,1};     //33 Einträge, schräg hoch & runter & obenrum
                                                                    //arstp=157, anza=32
              
  asa = ase;                    // asa = Säulenleds aus oder def. Farbe, ase = Säulenleds ein oder neue Farbe 
                                 // wird hier für Würfel verwendet
  ase = aniw[arstp + ablco1];   // im ase steht die würfel nr. die eingeschaltet werden soll
                                //arstp = array startpunkt einer animation,  
  richt();            //animationsrichtung - links oder rechtsrum, braucht anza = anzahl animationen

  for (byte i = 0; i < lepra; i ++)  {   // schaltet vorigen Würfel aus oder default
    ALed = wuerf[asa * lepra + i];     // lepra = anzahl der Leds pro animation, 
    leds[ALed] = CHSV(hue1, sat1, valu1);
  } 
...
//--------------------------  
  FastLED.show();  
   if (anico == 200) {  // animations counter - zählt die anaimationsdurchläufe 
      neufa();
    anico = 0;
   } 
}
...
//lokale variable
  ...
  static byte lrrd;    // local random richtungs dauer
  byte z1;    //zähler 1
  //static byte farb;   //2 Farben abwechselnd 
...
void inp3() {           // Serieller Input bei 3 char Eingabe
  ...
  if (wert1 == 'p') {     // Poti / Tastatursteuerung umschaltung
    ...
    if (wert2 == '0')  {     // 
      if (wert3 == '0') {    //
        ...
        Serial.println("Farbeneinstellung aus");                                                      
      }      
    }
  ...
  //-------------------- schlange ----------------------------------
    ...
    if (wert2 == 'u')  {     //ascii u für Würfel animationen
      ...
      if (wert3 == '1') {    //animation Würfel vertikal vor & zurück
        anza = 72;           // Anzahl Animationen pro Durchlauf
        arstp = 0;     // array startpunkt einer animation,                                                        
      }
      else if (wert3 == '2') {    //animation Würfel auf und abwärts & vertikal vor & zurück
        anza = 155;           // Anzahl Animationen pro Durchlauf 
        arstp = 0;     // array startpunkt einer animation,             
      }
      else if (wert3 == '3') {    //animation Würfel 2 schräg hoch, runter, senkrecht runter
        anza = 32;           // Anzahl Animationen pro Durchlauf
        arstp = 157;     // array startpunkt einer animation,            
      }
      else if (wert3 == '4') {    //animation Würfel Zufallswerte rechtwinklige Bewegung 
      anima = 3;           // animations auswahl, welche anim gezeigt wird, 0 = keine      
        rws = 1;              // Startwert für Random generator
        rwe = 7;              // Endwert für Random generator                   
      }
      else if (wert3 == '5') {    //animation Würfel Zufallswerte 45 grad Bewegung
      anima = 3;           // animations auswahl, welche anim gezeigt wird, 0 = keine      
        rws = 7;              // Startwert für Random generator
        rwe = 19;              // Endwert für Random generator                   
      }      
      else if (wert3 == '6') {    //animation Würfel Zufallswerte rechtwinklige & 45 grad Bewegung
      anima = 3;           // animations auswahl, welche anim gezeigt wird, 0 = keine      
        rws = 1;              // Startwert für Random generator
        rwe = 19;              // Endwert für Random generator                  
      }
    ...
    ///////////////////////////////////// Figuren ///////////////////////////////////////
        ...
        else if (wert3 == '3') {            //Würfel Umriss ein mit Farbanimation
         anima = 10;           // animations auswahl, welche anim gezeigt wird, 0 = keine    
          anico = 25;
        }
        else if (wert3 == '4')  {  // Würfelumriss und kleines Drehkreuz in Mitte mit Farbanimation
