// Filename als String
String filn = "NPW_Mega2560_V1.ino"; 
/*  
 *  ###########################################
...
void setup() {
  ...
  anico = 0;          //animcounter  
  Serial.println();
  Serial.println("Im DEMO Mode - ausschalten mit  d ");
        ...
        if (Serial.available() > 0) { //Eingabebuffer checken
          ...
          if (ttyb == 1)  {
            ...
            switch (ttyin) {
             ...
             case '5':          //              
              anig = 60;
              Serial.print("Animationsgeschwindigkeit default "); Serial.println(anig);               
              break;              //
              //
             ...
             case 'F':          // setzt default Farbwerte
              ...
              setfa();         //set alle Leds auf default Farbwerte                //
              Serial.println("Default Farbwerte setzen");
              break;
              //
             case 'G':                //  Animationsgeschindigkeit mit Poti oder Tastatur einstellen
                                      //- kleinere Werte = höhere Geschwindigkeit
             Serial.println("Ani.Tempo einstellen");    // Geschindigkeit mit Poti / Tastatur
              pots = 20;          
              break;
             //
             ...
             case 'i':
              ...
              Serial.print(" Animations Nr. "); Serial.print(anima); // welche Animation läuft                           
          ...
          //          
              ...
              Serial.println("Fehler: > 3 char. Eingabe");    
